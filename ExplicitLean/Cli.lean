...
inductive Command where
  ...
  | admit
  /-- Capture, admit, and print the generated module to standard output without
  publishing it or running the later checks. -/
  | lower
...
def usage : String :=
  "usage: explicit-lean compile|capture-debug|admit|lower \
