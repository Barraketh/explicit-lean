...
Updated 2026-08-31T15:55:59.117516+00:00

- Indexed: 83,425 calls in 8,264 modules.
- Accepted per-module verification: 53 translated calls in 12 modules.
- Provisional cache awaiting current semantic checks: 617 calls in 54 modules.
...
Queue: failed=70, queued=1, running=1, succeeded=66, unplanned=8126

## Active modules

- `Mathlib/Data/Nat/BinaryRec.lean` (schema10-expansion)

## Failures and partial results

- `Mathlib/Algebra/Algebra/Defs.lean`: materializer exit 1
...
- `Mathlib/Analysis/CStarAlgebra/Multiplier.lean`: materializer exit 1
...
- `Mathlib/Computability/Ackermann.lean`: materializer exit 1
- `Mathlib/Computability/Encoding.lean`: materializer exit 1
- `Mathlib/Condensed/Discrete/LocallyConstant.lean`: materializer exit 1
