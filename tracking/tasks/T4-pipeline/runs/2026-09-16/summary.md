...
Generated 2026-09-16T23:17:08.
T1 `task/T1-trace-capture` at `697f16bb3a3408ca7cef14d1b8fecf60fbf0d515` (dirty); T2 `task/T2-explicit-rw` at `0fab2ca4e044253e3cd118a2e610ace9bea6560d` (dirty).

| module | sites | replayed | unresolved | render_failed | compile_failed | mode | s |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Logic/IsEmpty/Basic.lean` | 17 | 15 | 0 | 0 | 2 | per_site | 39 |
| `Logic/Nontrivial/Defs.lean` | 1 | 1 | 0 | 0 | 0 | whole_module | 4 |
| `Logic/Function/Defs.lean` | 2 | 1 | 0 | 0 | 1 | per_site | 8 |
| `Logic/ExistsUnique.lean` | 8 | 8 | 0 | 0 | 0 | whole_module | 5 |
| `Logic/Function/Basic.lean` | 23 | 9 | 4 | 5 | 5 | per_site | 43 |
| `Logic/Basic.lean` | 31 | 11 | 1 | 7 | 12 | per_site | 67 |
| **total** | **82** | **45** | **5** | **12** | **20** | | |
...
| `Logic/Function/Defs.lean` | 2 | 139 | `compile_failed` | t1 | unexpected token '=='; expected ')', ',' or ':' |
...
| `Logic/Function/Basic.lean` | 7 | 664 | `unresolved:discharged by rewriting to True, steps not recorded` | t1 | the recorder classified this call as unresolved: discharged by rewriting to True, steps not recorded |
...
| `Logic/Function/Basic.lean` | 10 | 796 | `unresolved:discharged by rewriting to True, steps not recorded` | t1 | the recorder classified this call as unresolved: discharged by rewriting to True, steps not recorded |
...
| `Logic/Function/Basic.lean` | 18 | 975 | `unresolved:discharged by rewriting to True, steps not recorded` | t1 | the recorder classified this call as unresolved: discharged by rewriting to True, steps not recorded |
...
| `Logic/Basic.lean` | 8 | 552 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
...
| `Logic/Basic.lean` | 18 | 899 | `render_failed:inaccessible_name` | t1 | rw.name 'h✝' is an inaccessible display name, which does not lex |
| `Logic/Basic.lean` | 19 | 917 | `compile_failed` | t1 | explicit_rw: step 1: `unfold Ne` was applied where the head constant is `Iff`. |
| `Logic/Basic.lean` | 20 | 962 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
| `Logic/Basic.lean` | 21 | 973 | `unresolved:nested simp steps could not be placed in the side goal` | t1 | the recorder classified this call as unresolved: nested simp steps could not be placed in the side goal |
| `Logic/Basic.lean` | 22 | 987 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
| `Logic/Basic.lean` | 23 | 990 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
| `Logic/Basic.lean` | 24 | 1007 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
| `Logic/Basic.lean` | 25 | 1011 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
| `Logic/Basic.lean` | 26 | 1015 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
| `Logic/Basic.lean` | 27 | 1019 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
| `Logic/Basic.lean` | 28 | 1051 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
| `Logic/Basic.lean` | 29 | 1055 | `compile_failed` | t1 | explicit_rw: step 1: Application type mismatch: The argument |
