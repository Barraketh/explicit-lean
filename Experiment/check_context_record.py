...
def main() -> None:
    ...
    if not validation or validation.get("schemaVersion") != 5:
        raise RuntimeError("missing schema-v5 validation envelope")
    ...
    print("named-hypothesis context recording, schema-v5 transport, and materialization passed")
