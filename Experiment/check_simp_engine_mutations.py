#!/usr/bin/env python3
"""Require schema-18 replay to reject focused single-field mutations."""
...
def main() -> None:
    ...
    if "SIMP_ENGINE_MUTATIONS core=10" not in run.stdout or \
    ...
    print("schema-18 replay mutations: 21 rejected: ok")
